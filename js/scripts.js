...
$(".right").click(function() {
  ...
  $("#whole2").hide();
  $("#display").show();
  $('#mean_val').append(main_arr[12]);
  $("#mean_val").fadeIn(2000);
  $('#spice').append(main_arr[0].restaurant.location.city);
  $('#loss').append(main_arr[0].restaurant.name);
  $('#W').append(main_arr[10].restaurant.name);
  $('#one').append(main_arr[2].restaurant.name);

  $('#two').append(main_arr[4].restaurant.name);
  $('#three').append(main_arr[6].restaurant.name);
  $('#four').append(main_arr[8].restaurant.name);
});
